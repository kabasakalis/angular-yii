        ...
        <table width="100%" height="100%">
            <tr>
                <td width="20%" nowrap valign="top" style="padding: 10px;">
                    ...
                    <p><a target="_blank" href="http://reference.developercompanion.com/index.php#/Tools/FirePHPCompanion/Quickstart/">Download &amp Install</a> Quickstart Examples</p>

                    <p>Requires <a target="_blank" href="http://getfirebug.com/">Firebug</a> and <a target="_blank" href="http://www.christophdorn.com/Tools/index.php#FirePHP Companion LITE">FirePHP Companion LITE</a>.<br/>
